...
- **Create / rename / delete** collections with **`POST`**, **`PATCH`**, and **`DELETE`** on **`/api/v1/collections`** (see [Workspace and collections — Manage collections](end-user/workspace-and-collections.md#manage-collections-create-rename-delete)).
